        ...
        if (editing) {
            put(update.url(editing.id), {
                onSuccess: () => {
                    router.flushAll();
                    toast.success(
                        `Coupon "${data.code}" updated successfully!`,
                    );
                    handleClose();
                },
                onError: () => {
                    toast.error(
                        'Failed to update the coupon. Please check the form.',
                    );
                },
            });
        } else {
            post(store.url(), {
                onSuccess: () => {
                    router.flushAll();
                    toast.success(
                        `Coupon "${data.code}" created successfully!`,
                    );
                    handleClose();
                },
                onError: () => {
                    toast.error(
                        'Failed to create the coupon. Please check the form.',
                    );
                },
            });
        }
                ...
                <form onSubmit={handleSubmit} className="space-y-4 py-2">
                    ...
                    <div className="space-y-1.5">
                        ...
                        <textarea
                            ...
                            placeholder="Describe the coupon's purpose or conditions..."
