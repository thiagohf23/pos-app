        ...
        return (
            <div className="flex h-96 flex-col items-center justify-center p-12 text-center">
                ...
                <p className="mt-1 max-w-sm text-sm text-neutral-500 dark:text-neutral-400">
                    {searchTerm
                        ? t('categories.no_results_search_hint', 'Try adjusting your search terms or filter criteria.')
                        : t('categories.no_results_empty_hint', 'Get started by adding your first category.')}
                </p>
                {!searchTerm && (
                    <Button
                        onClick={onAddClick}
            ...
            <table className="w-full border-collapse text-left">
                <thead>
                    <tr className="border-b border-neutral-200 bg-neutral-50/50 text-xs font-semibold tracking-wider text-neutral-500 uppercase dark:border-neutral-800 dark:bg-neutral-900/50 dark:text-neutral-400">
                        ...
                        <th className="px-6 py-4">{t('products.description', 'Description')}</th>
                        <th className="px-6 py-4 text-center">{t('nav.products')}</th>
                    ...
                    {categories.map((category) => (
                        ...
                        >
                            ...
                            <td className="max-w-xs truncate px-6 py-4 text-sm text-neutral-500 dark:text-neutral-400">
                                {category.description || t('products.no_description', 'No description')}
                            </td>
